    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikeForCourses", x => x.ID);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "ID", "Amount", "CategoryId", "Content", "Image", "IsFree", "PublishDate", "Title", "ViewCount" },
                values: new object[,]
                {
                    { 1, 56m, 1, "Lorem ipsum dolor sit amet consectetur adipisicing elit.", "img1.jpg", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Product 1", 0 },
                    { 5, 37m, 1, "Lorem ipsum dolor sit amet consectetur adipisicing elit.", "img5.jpg", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Product 5", 0 },
                    { 2, 48m, 2, "Lorem ipsum dolor sit amet consectetur adipisicing elit.", "img2.jpg", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Product 2", 0 },
                    { 3, 75m, 2, "Lorem ipsum dolor sit amet consectetur adipisicing elit.", "img3.jpg", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Product 3", 0 },
                    { 4, 45m, 3, "Lorem ipsum dolor sit amet consectetur adipisicing elit.", "img4.jpg", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Product 4", 0 },
                    { 6, 89m, 3, "Lorem ipsum dolor sit amet consectetur adipisicing elit.", "img6.jpg", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Product 6", 0 }
                });
