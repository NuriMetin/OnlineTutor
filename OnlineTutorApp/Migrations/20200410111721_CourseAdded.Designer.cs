...
namespace OnlineTutorApp.Migrations
{
    ...
    [Migration("20200410111721_CourseAdded")]
            ...
            modelBuilder.Entity("OnlineTutorApp.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, Amount = 56m, CategoryId = 1, Content = "Lorem ipsum dolor sit amet consectetur adipisicing elit.", IsFree = true, PublishDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Product 1" },
                        new { ID = 2, Amount = 48m, CategoryId = 2, Content = "Lorem ipsum dolor sit amet consectetur adipisicing elit.", IsFree = true, PublishDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Product 2" },
                        new { ID = 3, Amount = 75m, CategoryId = 2, Content = "Lorem ipsum dolor sit amet consectetur adipisicing elit.", IsFree = true, PublishDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Product 3" },
                        new { ID = 4, Amount = 45m, CategoryId = 3, Content = "Lorem ipsum dolor sit amet consectetur adipisicing elit.", IsFree = true, PublishDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Product 4" },
                        new { ID = 5, Amount = 37m, CategoryId = 1, Content = "Lorem ipsum dolor sit amet consectetur adipisicing elit.", IsFree = true, PublishDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Product 5" },
                        new { ID = 6, Amount = 89m, CategoryId = 3, Content = "Lorem ipsum dolor sit amet consectetur adipisicing elit.", IsFree = true, PublishDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Product 6" }
                    );
                });
